...
const Dashboard = () => {
          ...
          {allResumes.map((resume, index) => {
            ...
            return (
              <button
                ...
                className='relative w-full sm:max-w-36 h-40 flex flex-col items-center justify-center rounded-lg gap-2 border group hover:shadow-lg transition-all duration-300 cursor-pointer'
                style={{
  ...
  <label
    ...
    className='flex flex-col items-center justify-center gap-2 border border-dashed border-slate-400 rounded-lg h-40 text-slate-400 hover:border-blue-500 hover:text-blue-700 cursor-pointer transition-colors'
  >
    {resume ? (
      <p className='text-blue-700 text-sm'>{resume.name}</p>
    ) : (
      <>
