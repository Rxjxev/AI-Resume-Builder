...
const ExperienceForm = ({ data, onChange }) => {
  ...
  const generateDescription = async (index) => {
    ...
    const prompt = `enhance thi job description ${experience.description} for the position of ${experience.position} at ${experience.company}.`
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full text-sm px-3 py-2 rounded-lg resize-none break-words whitespace-pre-wrap overflow-hidden leading-relaxed border border-gray-300 focus:ring-2 focus:ring-purple-300"
