...
const Features = () => {
  ...
  return (
     ...
     <div className="flex items-center gap-2 text-sm text-blue-800 bg-blue-400/10 rounded-full px-6 py-1.5">
        ...
        <Title title='Builde your resume' description='Our streamlined process helps you create a professional resume in minutes with intelligent AI-powered tools and features'/>
        
            <div className="flex flex-col md:flex-row items-center justify-center ">
                <img className="max-w-2xl w-full xl:-ml-32" src="/groupimage2.png" alt="" />
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Professional Design</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Modern layouts and typography that make your resume stand out to recruiters.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Smart Formatting</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Your resume is automatically structured to look clean, modern, and ATS-friendly.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">AI-Enhanced Content</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Polish your professional summary and job descriptions with smart AI suggestions.</p>
                            </div>
                        </div>
                    </div>
                </div>
